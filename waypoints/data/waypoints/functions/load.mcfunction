...
scoreboard objectives add cw-waypoints trigger

scoreboard objectives add tp.wayp dummy
scoreboard players set #tp.step tp.wayp 1

scoreboard players add #cc.available cc.module 1