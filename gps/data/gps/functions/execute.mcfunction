...
execute as @a if score @s cg-coords matches 1 run title @s actionbar [{"text":"X ","color":"gold"},{"score":{"name":"@s","objective":"gps.x"},"color":"white"},{"text":" Y ","color":"gold"},{"score":{"name":"@s","objective":"gps.y"},"color":"white"},{"text":" Z ","color":"gold"},{"score":{"name":"@s","objective":"gps.z"},"color":"white"}]
