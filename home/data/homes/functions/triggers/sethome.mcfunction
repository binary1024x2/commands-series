...
execute if predicate gps:player_in_overworld run tellraw @s[tag=!global.ignore.gui] [{"text":"Home location set at ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homex"},"color":"dark_aqua"},{"text":", ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homey"},"color":"dark_aqua"},{"text":", ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homez"},"color":"dark_aqua"},{"text":" in the Overworld","color":"dark_aqua"}]
execute if predicate gps:player_in_the_end run tellraw @s[tag=!global.ignore.gui] [{"text":"Home location set at ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homex"},"color":"dark_aqua"},{"text":", ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homey"},"color":"dark_aqua"},{"text":", ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homez"},"color":"dark_aqua"},{"text":" in the The End","color":"dark_aqua"}]
execute if predicate gps:player_in_the_nether run tellraw @s[tag=!global.ignore.gui] [{"text":"Home location set at ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homex"},"color":"dark_aqua"},{"text":", ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homey"},"color":"dark_aqua"},{"text":", ","color":"dark_aqua"},{"score":{"name":"@s","objective":"tp.homez"},"color":"dark_aqua"},{"text":" in the The Nether","color":"dark_aqua"}]
